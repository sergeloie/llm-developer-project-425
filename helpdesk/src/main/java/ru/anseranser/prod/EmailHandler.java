 ...
 * <p>
 * Delegates all real work to {@link EmailReceiver}, {@link EmailTextExtractor},
 * {@link AgentClient}, and {@link EmailSender}.
 */
public class EmailHandler implements YcFunction<String, String> {
     ...
     */
    EmailHandler(EmailReceiver receiver, EmailSender sender, AgentClient agent, EmailTextExtractor extractor) {
